...
- UI changes and scheduler/algorithm changes
- Review-session state and IndexedDB persistence changes
- The scheduler engine and the storage layer in one step
