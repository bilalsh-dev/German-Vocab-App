...
## Current Phase
- Feature 04 (card data model + Dexie storage) complete. Next: Feature 05 (card rendering).

## Current Goal
- Feature 05 — card rendering (`context/feature-specs/05-card-rendering.md`): front/back renderer using `lib/content` helpers (gender color, vowel marks, POS blocks, examples).
...
## Next Up
- Implement Feature 05 (card rendering), then proceed through the roadmap in order.
